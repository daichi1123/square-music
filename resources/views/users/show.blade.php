...
<ul class="nav nav-tabs nav-justified mt-5 mb-4">
    <li class="nav-item nav-link {{ Request::is('users/' . $user->id) ? 'active' : '' }}"><a href="{{ route('users.show',['id'=>$user->id]) }}" class="">Playlist<br><div class="badge badge-secondary">{{ $count_songs }}</div></a></li>
